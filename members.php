...
if(isset($_SESSION['Username'])){
  ...
  $page_title = 'MEMPERS'; // The page name
  ...
  if($do== "Mangae"){
            //chek if the user exist in databases and select all users excpt admin
            $stetment=$connection->prepare("SELECT * FROM users WHERE GroubID != 1");
